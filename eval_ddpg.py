"""Evaluate the tuned DDPG on the 10 eval seeds (0-9).

Run:  python eval_ddpg.py
Loads best_ddpg.json, trains one fresh agent per seed, and reports the three graded
numbers averaged over the seeds that solved. Results persist to eval_ddpg_results.json
