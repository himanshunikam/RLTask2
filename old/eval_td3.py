"""Evaluate the tuned TD3 on the 10 eval seeds (0-9).

Run:  python eval_td3.py
Loads best_td3.json, trains one fresh agent per seed, and reports the three graded
numbers averaged over the seeds that solved. Results persist to eval_td3_results.json
